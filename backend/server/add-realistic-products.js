...
const addRealisticProducts = async () => {
    try {
        ...
        // ========== FRESH VEGETABLES ==========
        const vegetables = [
            { name: 'Fresh Tomatoes (Local)', price: 80, stock: 200, unit: 'kg', isFeatured: true, images: ['https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=500&q=80', 'https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=500&q=80', 'https://images.unsplash.com/photo-1607305387299-a3d9611cd469?w=500&q=80'], tags: ['fresh', 'vegetables', 'tomatoes', 'local'], category: categoryMap['Leafy Vegetables'] || categoryMap['Fresh Vegetables'] },
            { name: 'Cherry Tomatoes (Imported)', price: 180, stock: 80, unit: 'kg', images: ['https://images.unsplash.com/photo-1464226066583-1bc72d59ddd2?w=500&q=80', 'https://images.unsplash.com/photo-1603048719539-9ecb4aa395e3?w=500&q=80'], tags: ['fresh', 'vegetables', 'cherry tomatoes', 'imported'], category: categoryMap['Exotic Vegetables'] || categoryMap['Fresh Vegetables'] },
            { name: 'Green Cucumber', price: 50, stock: 150, unit: 'kg', images: ['https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=500&q=80', 'https://images.unsplash.com/photo-1604977042946-1eecc30f269e?w=500&q=80'], tags: ['fresh', 'vegetables', 'cucumber'], category: categoryMap['Fresh Vegetables'] },
            { name: 'English Cucumber', price: 120, stock: 60, unit: 'kg', images: ['https://images.unsplash.com/photo-1568584711271-e21d3fa9005b?w=500&q=80', 'https://images.unsplash.com/photo-1553452118-621e97e33600?w=500&q=80'], tags: ['fresh', 'vegetables', 'cucumber', 'imported'], category: categoryMap['Exotic Vegetables'] || categoryMap['Fresh Vegetables'] },
            { name: 'Fresh Carrots (Deshi)', price: 70, stock: 180, unit: 'kg', isFeatured: true, images: ['https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=500&q=80', 'https://images.unsplash.com/photo-1447175008436-054170c2e979?w=500&q=80', 'https://images.unsplash.com/photo-1582515073490-39981397c445?w=500&q=80'], tags: ['fresh', 'vegetables', 'carrots', 'local'], category: categoryMap['Root Vegetables'] || categoryMap['Fresh Vegetables'] },
            { name: 'Baby Carrots (Premium)', price: 200, stock: 50, unit: 'kg', images: ['https://images.unsplash.com/photo-1582515073490-39981397c445?w=500&q=80', 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=500&q=80'], tags: ['fresh', 'vegetables', 'carrots', 'premium'], category: categoryMap['Exotic Vegetables'] || categoryMap['Fresh Vegetables'] },
